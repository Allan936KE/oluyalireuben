...
import com.example.universityportal.databinding.ActivityAddedUnitsBinding;
...
public class AddedUnits extends AppCompatActivity {
    ActivityAddedUnitsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAddedUnitsBinding.inflate(getLayoutInflater());
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AddedUnits.this, LecturerDashboard.class));
            }
        });
        ...
        onUnitClicked = new UnitsAdapter.OnUnitClicked() {
            ...
            public void onUnitClicked(int position) {
                startActivity(new Intent(AddedUnits.this, UnitsDetails.class)
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setAdapter(new UnitsAdapter(units, AddedUnits.this, onUnitClicked));
            }
